...
function createWindow() {
  ...
  imageWindow = new BrowserWindow({width: 900, height: 680, parent: mainWindow, show: false});
  settingsWindow = new BrowserWindow({width: 900, height: 680, parent: mainWindow, show: false});
